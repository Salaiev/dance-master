...
export default function AdminLessonCreate() {
  ...
  async function onSubmit(e) {
    ...
    try {
      ...
      const res = await fetch(`${process.env.REACT_APP_BACKEND_SERVER_URI}/lessons`, {
        method: "POST",
        headers: {
    ...
    <div style={page}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", gap: 12, marginBottom: 14 }}>
        <div>
          ...
          <div style={{ color: "#6b7280", marginTop: 6 }}>
            Title, YouTube URL, estimated time, and detailed instructions.
          </div>
        </div>
      ...
      <form onSubmit={onSubmit} style={card}>
        <div style={{ marginBottom: 12 }}>
          ...
          {fieldErrors.title && <div style={{ color: "crimson", marginTop: 6, fontSize: 13 }}>{fieldErrors.title}</div>}
        </div>
        ...
        <div style={row2}>
          <div style={{ marginBottom: 12 }}>
            ...
            {fieldErrors.style && <div style={{ color: "crimson", marginTop: 6, fontSize: 13 }}>{fieldErrors.style}</div>}
          </div>
          ...
          <div style={{ marginBottom: 12 }}>
            ...
            {fieldErrors.difficulty && <div style={{ color: "crimson", marginTop: 6, fontSize: 13 }}>{fieldErrors.difficulty}</div>}
          </div>
        </div>
        ...
        <div style={row2}>
          <div style={{ marginBottom: 12 }}>
            ...
            {fieldErrors.video_url && <div style={{ color: "crimson", marginTop: 6, fontSize: 13 }}>{fieldErrors.video_url}</div>}
          </div>
          ...
          <div style={{ marginBottom: 12 }}>
            ...
            <input
              ...
              inputMode="numeric"
            />
            {fieldErrors.estimated_minutes && <div style={{ color: "crimson", marginTop: 6, fontSize: 13 }}>{fieldErrors.estimated_minutes}</div>}
          </div>
        </div>
        ...
        <div style={{ display: "flex", gap: 10, justifyContent: "flex-end", marginTop: 14 }}>
          <button type="button" style={btn} onClick={() => navigate("/dance-master/lessons")} disabled={loading}>
            Cancel
          </button>
