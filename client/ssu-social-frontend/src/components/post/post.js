...
// ✅ COMMENTS REMOVED: comment icons removed
...
// ✅ COMMENTS REMOVED: CreateComment import removed
...
const Post = ({ posts: post, isDiscover, disableTooltip = false }) => {
  ...
  // ✅ COMMENTS REMOVED: commentCount removed
  ...
  // ✅ COMMENTS REMOVED: showCommentCard + animation states removed
  ...
  }, [post]); // ✅ COMMENTS REMOVED: showCommentCard removed from deps
  ...
  useEffect(() => {
    ...
    // ✅ COMMENTS REMOVED: fetchCommentCount + comment socket listener removed
  }, [post._id]);
    ...
    const fetchViewCount = async () => {
      try {
        ...
        if (
          ...
          response.data.viewCount !== undefined
        ) {
          ...
          <div>
            ...
            <div className="flex flex-col items-start space-y-2 mt-2">
              <div className="flex flex-row items-center space-x-4">
                ...
                {/* ✅ COMMENTS REMOVED: comment button removed */}
      ...
      <Modal show={showEditModal} onHide={handleCloseEditModal}>
        ...
        >
          <button
            ...
            title={
              editedPost.isSensitive ? "Unmark as sensitive" : "Mark as sensitive"
            }
          >
